...
namespace Controller
{
    public class Utils
    {
        public static List<Item> CreateFakeItem()
        {
            ...
            items.Add(new Item(0, "Galaxy S Ultra", "Điện tử", 20, "Samsung", DateTime.Now, 19000000, null));
            ...
            items.Add(new Item(0, "Áo tay dài", "Thời trang", 90, "An Phước", DateTime.Now, 1000000, null));
